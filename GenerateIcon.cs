...
class Program
{
    static void Main()
    {
        string assetsPath = Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "..", "..", "..", "..", "DesktopCalendar", "Assets");
        Directory.CreateDirectory(assetsPath);
        
        string iconPath = Path.Combine(assetsPath, "app.ico");
        ...
        Console.WriteLine($"图标已生成: {iconPath}");
    }
